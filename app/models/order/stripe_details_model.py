...
class StripeDetails(Base):
    ...
    stripe_charge_id = Column(BYTEA, nullable=True, default=None, comment="Encrypted Stripe charge ID")
    ...
    stripe_error_log = Column(Text, nullable=True, default=None, comment="Store error details for failed transactions")
    ...
    # Foreign Keys
    transaction_uuid = mapped_column(UUID(as_uuid=True), ForeignKey("transactions.uuid"), nullable=False, comment="Транзакция")
