...
class LenderPaymentBase(BaseModel):
    payment_percentage: Annotated[Decimal, Field(..., ge=0, le=100, description="Percentage of rental income paid to lender.")]
    payment_amount: Annotated[Decimal, Field(..., description="Amount paid to the lender.")]
...
class LenderPaymentUpdate(LenderPaymentBase):
    payment_percentage: Optional[Annotated[Decimal, Field(ge=0, le=100, description="Percentage of rental income paid to lender.")]] = None
    payment_amount: Optional[Annotated[Decimal, Field(description="Amount paid to the lender.")]] = None
