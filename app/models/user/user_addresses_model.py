...
class UserAddresses(Base):
    ...
    address_type = Column(String(8), nullable=True, comment="e.g., Shipping, Billing, Both")
    ...
    # Foreign Keys
    user_uuid = Column(UUID(as_uuid=True), ForeignKey('users.uuid'), nullable=False, comment="Пользователь")
