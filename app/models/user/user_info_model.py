...
class UserInfo(Base):
    ...
    lender = Column(Boolean, nullable=False, default=False, comment='Лендер ли пользователь')
    ...
    # Foreign keys
    user_uuid = mapped_column(UUID(as_uuid=True), ForeignKey("users.uuid"), nullable=False, comment='Пользовтаель')
