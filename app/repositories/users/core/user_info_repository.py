...
from app.schemas.users import UserInfoUpdate, UserInfoCreate
...
class UserInfoRepository(CachingMixin, BulkActionsMixin, SearchMixin):
    ...
    def create_user_info(
        self, db_session: Session, user_id: UUID, user_info_data: UserInfoCreate
    ) -> UserInfo:
        """Creates new user info."""
        new_instance = self.model(user_id=user_id, **user_info_data.model_dump())
