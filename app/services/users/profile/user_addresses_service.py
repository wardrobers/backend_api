...
class UserAddressesService:
    ...
    def get_address_by_id(
        ...
        """
        address = user_address_repository.get_address_by_id(address_id)
    ...
    def get_addresses_by_user_id(self, user_id: UUID4) -> list[UserAddressRead]:
        ...
        """
        return user_address_repository.get_addresses_by_user_id(user_id)

    def create_user_address(
        self, db_session: Session, user_id: UUID4, address_data: UserAddressCreate
    ) -> UserAddressRead:
        """
        ...
        address = user_address_repository.add_user_address(user_id, address_data)
        return UserAddressRead.model_validate(address)
    ...
    def update_user_address(
        ...
        address = user_address_repository.update_user_address(address_id, address_data)
        return UserAddressRead.model_validate(address)
    ...
    def delete_user_address(self, address_id: UUID4, current_user_id: UUID4) -> None:
        ...
        user_address_repository.delete_user_address(address_id)
    ...
    def set_default_address(
        ...
        existing_default_address = (
            user_address_repository.get_address_by_user_id_and_type(
                user_id, address_type
            )
        )

        with user_address_repository.db_session as session:
