...
class PromotionsAndDiscounts(Base):
    ...
    max_uses = Column(Integer, nullable=True, comment="Number of times this promo can be used")
    uses_left = Column(Integer, nullable=True)
    active = Column(Boolean, default=True, comment="To quickly enable/disable promotions without deleting")
