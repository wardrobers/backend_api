...
class MaterialRepository:
    ...
    def get_material_by_id(self, uuid: UUID4) -> Optional[Material]:
        return self.db.query(Material).filter(Material.id == uuid).first()
    ...
    def update_material(
        ...
        material = self.get_material_by_id(uuid)
        if material:
